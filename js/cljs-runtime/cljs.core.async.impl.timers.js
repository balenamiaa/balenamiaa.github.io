...
var i_15495 = (self__.level + (1));
while(true){
if((i_15495 <= (new_level + (1)))){
(update[i_15495] = self__.header);

var G__15497 = (i_15495 + (1));
i_15495 = G__15497;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_15498 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_15498[i]));
} else {
x__$2.forward.push((((i < links_15498.length))?(links_15498[i]):null));
}

if((i < links_15498.length)){
(links_15498[i] = x__$2);
} else {
links_15498.push(x__$2);
}
...
var i_15511 = (0);
while(true){
if((i_15511 <= self__.level)){
var links_15516 = (update[i_15511]).forward;
if((x__$1 === (((i_15511 < links_15516.length))?(links_15516[i_15511]):null))){
(links_15516[i_15511] = (x__$1.forward[i_15511]));

var G__15521 = (i_15511 + (1));
i_15511 = G__15521;
continue;
} else {
var G__15522 = (i_15511 + (1));
i_15511 = G__15522;
continue;
}
} else {
...
var G__15537 = nx;
var G__15538 = (level__$1 - (1));
x = G__15537;
level__$1 = G__15538;
continue;
} else {
var G__15539 = x;
var G__15540 = (level__$1 - (1));
x = G__15539;
level__$1 = G__15540;
continue;
}
