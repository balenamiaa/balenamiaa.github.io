...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_12228 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_12228(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_12229 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_12229(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_12230 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_12230(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_12231 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_12231(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_12232 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_12232(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_12233 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_12233(reader);
}
});
...
var G__12247 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null, );
var G__12248 = s.append(c);
c = G__12247;
s = G__12248;
continue;
}
