...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_11730 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_11730(runtime,msg);
}
});
...
var shadow$remote$runtime$api$IRuntime$del_extension$dyn_11740 = (function (runtime,key){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_11740(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_11741 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_11741(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_11789 = (function (runtime,input,callback){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_11789(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_11802 = (function (runtime,code){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_11802(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__11724,callback){
var map__11725 = p__11724;
var map__11725__$1 = cljs.core.__destructure_map(map__11725);
var input = map__11725__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11725__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11725__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
