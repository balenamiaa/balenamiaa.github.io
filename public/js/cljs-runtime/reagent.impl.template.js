...
var G__18915 = o;
reagent.impl.template.goog$module$goog$object.set(G__18915,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null, v)));
...
var G__18935 = o;
reagent.impl.template.goog$module$goog$object.set(G__18935,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__19211__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__19212__i < G__19212__a.length) {G__19212__a[G__19212__i] = arguments[G__19212__i + 0]; ++G__19212__i;}
  args = new cljs.core.IndexedSeq(G__19212__a,0,null);
} 
return G__19211__delegate.call(this,args);};
G__19211.cljs$lang$maxFixedArity = 0;
G__19211.cljs$lang$applyTo = (function (arglist__19213){
var args = cljs.core.seq(arglist__19213);
return G__19211__delegate(args);
});
...
var G__18941 = props;
var G__18941__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__18941,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__18941);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__18941__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__18968 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__18968,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__18968;
}
})(),id_class);
...
var G__18975 = (cljs.core.count(argv) - first_child);
switch (G__18975) {
case (0):
...
var vec__18990 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18990,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18990,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18990,(2),null);
...
var temp__5808__auto___19259 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___19259 == null)){
} else {
var key_19261 = temp__5808__auto___19259;
(jsprops.key = key_19261);
}
...
var temp__5808__auto___19264 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___19264 == null)){
} else {
var key_19265 = temp__5808__auto___19264;
(jsprops.key = key_19265);
}
...
var temp__5808__auto___19270 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___19270 == null)){
} else {
var key_19272 = temp__5808__auto___19270;
(jsprops.key = key_19272);
}
...
var temp__5808__auto___19306 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___19306 == null)){
} else {
var key_19310 = temp__5808__auto___19306;
(jsprops.key = key_19310);
}
...
var temp__5808__auto___19312 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___19312 == null)){
} else {
var key_19314 = temp__5808__auto___19312;
(jsprops.key = key_19314);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__19039_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__19039_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__19044 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19044,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19044,(1),null);
...
break;
default:
var G__19357 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__19358 = compiler;
v = G__19357;
compiler = G__19358;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template19107 = (function (opts,id,fn_to_element,parse_fn,meta19108){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template19107.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_19109,meta19108__$1){
var self__ = this;
var _19109__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template19107(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta19108__$1));
}));

(reagent.impl.template.t_reagent$impl$template19107.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_19109){
var self__ = this;
var _19109__$1 = this;
return self__.meta19108;
}));

(reagent.impl.template.t_reagent$impl$template19107.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template19107.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template19107.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template19107.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template19107.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template19107.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta19108","meta19108",2062813033,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template19107.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template19107.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template19107");

(reagent.impl.template.t_reagent$impl$template19107.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template19107");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template19107.
 */
reagent.impl.template.__GT_t_reagent$impl$template19107 = (function reagent$impl$template$__GT_t_reagent$impl$template19107(opts,id,fn_to_element,parse_fn,meta19108){
return (new reagent.impl.template.t_reagent$impl$template19107(opts,id,fn_to_element,parse_fn,meta19108));
});
...
return (new reagent.impl.template.t_reagent$impl$template19107(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
